        ...
        try:
            if pic.endswith((".tgs", ".webp")):
                ...
                shites = await bot.send_message(
                    event.chat_id,
                    f"🔥 **ONLINE**\n**Lord {ALIVE_NAME} Sudah kembali kebumi**\n**Sejak :** `{total_afk_time}` **Yang Lalu**",
                )
            else:
            ...
            shite = await bot.send_message(
                event.chat_id,
                f"🔥 **ONLINE**\n**Lord {ALIVE_NAME} Kembali kebumi**\n**Sejak :** `{total_afk_time}` **Yang Lalu**",
            )
        ...
        try:
            if reason and pic:
                if pic.endswith((".tgs", ".webp")):
                    ...
                    await bot.send_message(
                        BOTLOG_CHATID,
                        f"#AFK\n**{ALIVE_NAME} Telah AFK dari dunia**\n**Karena :** `{reason}`",
                    )
                else:
                    await bot.send_message(
                        BOTLOG_CHATID,
                        f"#AFK\n**{ALIVE_NAME} Sedang AFK dari dunia**\n**Karena :** `{reason}`",
                        file=pic,
                    )
            elif reason:
                await bot.send_message(
                ...
                await bot.send_message(
                    BOTLOG_CHATID, f"#AFK\n**{ALIVE_NAME} Masih aja AFK karna dia sibuk**"
                )
