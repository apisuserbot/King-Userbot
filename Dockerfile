...
#              USERBOT TELEGRAM
# ==========================================
RUN git clone -b King-Userbot https://github.com/ZenitsuXD/King-Userbot /home/King-Userbot \
...
RUN pip3 install -r https://raw.githubusercontent.com/ZenitsuXD/King-Userbot/King-Userbot/requirements.txt
